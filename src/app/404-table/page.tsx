...
import { ArrowLeft, Table, AlertCircle, QrCode } from 'lucide-react';
      ...
      <div className="max-w-md w-full text-center">
        ...
        <div className="mb-8">
          <div className="mx-auto w-24 h-24 bg-orange-100 rounded-full flex items-center justify-center">
            <Table className="w-12 h-12 text-orange-600" />
          </div>
        </div>
        ...
        <p className="text-gray-600 mb-8 leading-relaxed">
          A mesa que você está tentando acessar não foi encontrada no sistema do restaurante.
        </p>
          ...
          <div className="flex items-start">
            ...
            <div className="text-left">
              ...
              <ul className="text-sm text-blue-700 space-y-1">
                <li>• Verifique se escaneou o QR Code correto da sua mesa</li>
                <li>• Certifique-se de estar no restaurante correto</li>
                <li>• Solicite ajuda ao garçom ou atendente</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="text-left">
              ...
              <ul className="text-sm text-amber-700 space-y-1">
                <li>• QR Code danificado ou incorreto</li>
                <li>• Mesa temporariamente indisponível</li>
                <li>• Sistema em manutenção</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200">
          ...
          <p className="text-sm text-gray-600">
            Solicite ajuda ao garçom ou funcionário do restaurante.
          </p>
        </div>
