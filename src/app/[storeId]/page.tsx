...
import { useEffect, useState, Suspense, useRef, use } from 'react';
...
export default function StorePageWrapper({ params }: StorePageProps) {
  const resolvedParams = use(params);
  console.log('Renderizando StorePageWrapper', resolvedParams);
  return (
    <Suspense fallback={<MenuLoading />}>
      <MenuPage storeId={resolvedParams.storeId} />
    </Suspense>
  );
}

function MenuPage({ storeId }: { storeId: string }) {
  console.log('Renderizando MenuPage - Início', storeId);
